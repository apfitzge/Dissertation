\chapter{Spatial Decomposition}{\label{ch:Spatial Decomposition}
  ...
  \section{Applications for MPACT}{\label{sec:Spatial Decomposition:Applications for MPACT}
    ...
    If a subdomain wraps around another (3 surrounding sides), the portion of the subdomain that is wrapped is moved into the wrapping subdomain.
  ...
  \section{Partition Refinement}{\label{sec:Spatial Decomposition:Partition Refinement}
    ...
    \subsection{Partition Refinement Methods}{\label{ssec:Spatial Decomposition:Partition Refinement Methods}
      ...
      This algorithm prioritizes vertex pairs that are geometrically distant from one another.
  ...
  \section{Conclusions}{\label{sec:Spatial Decomposition:Conclusions}
    ...
    This analysis was performed on a 3-D core, that was relatively homogeneous in the axial direction; if a core design were to be more axially heterogeneous, then a more significant increase in performance might be expected.
