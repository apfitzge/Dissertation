\chapter{The Method of Characteristics}{\label{ch:The Method of Characteristics}
    ...
    \section{The Linear-Source Approximation}{\label{sec:MOC:LSA}
        ...
        \subsection{Derivation}{\label{ssec:MOC:LSA:Derivation}
            ...
            For the remainder of this section, the formulation as it was originally derived by \citet{Ferrer2016} is shown.
            ...
            The original derivation further simplified \cref{eqs:MOC:LSA:Region-Averaged Flux Moments Definitions} into the following form.
        ...
        \subsection{Isotropic Simplifications}{\label{ssec:MOC:LSA:Isotropic Simplifications}
            ...
            It was demonstrated for the \acf{BandW} experiments [CITATION] that considering anisotropic scattering only in the spatially flat flux moments that only $\sim$10 pcm error in eigenvalue resulted.
        ...
        \subsection{Applications}{\label{ssec:MOC:LSA:Applications}
            ...
            As part of this work, a spatial mesh discretization study was performed on problems with multi-physics applications in mind \cite{Fitzgerald2019}; this is presented in more detail in \cref{ch:Improved Linear Source Formulation for Multi-physics and 2D/1D Applications}.
        }
    }
