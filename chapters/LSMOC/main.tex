\chapter{Improved Linear Source Formulation for Multi-physics and 2D/1D Applications}{
  ...
  \section{Exponential Tabulation}{\label{sec:LSMOC:Exponential Tabulation}
    ...
    These functions all involve an exponential, $e^{-\segopt}$; although this does not present a problem mathematically, the exponential function is a transcendental function that tends to be slow when evaluated analytically on computers.
    ...
    \subsection{Function Modification}{\label{ssec:LSMOC:ET:Function Modification}
      ...
      Although one approach is to tabulate the $\modFunc$ function in place of the $F_2(\segopt)$ function, and multiply by $\nsegl$ during evaluation, it is possible to tabulate a single function and compute the others.
      ...
      \subsubsection{Results using More Accurate Tables}{\label{sssec:LSMOC:ET:Results using More Accurate Tables}
        ...
        \begin{table}
          ...
          \begin{tabular}{@{}ccrrrrrrrrr@{}}\toprule
            Method & Table Type & Order & \multicolumn{2}{c}{\shortstack[c]{Exponential\\Time (s)}} & & \multicolumn{2}{c}{\ac{MOC} Time (s)} && \multicolumn{2}{c}{Memory}\\\cmidrule{4-5}\cmidrule{7-8}\cmidrule{10-11}
            ...
            \multirow{6}{*}{3-Functions}     & \multirow{3}{*}{Uniform}        & 1 & 382.6 & 360.3 && 622.5 & 591.0 && 8.04 GB & 458 MB \\\addlinespace[-0.2em]
                                                                              && 2 & 121.3 & 151.7 && 343.2 & 372.1 && 85.7 MB & 4.8 MB \\\addlinespace[-0.2em]
                                                                              && 3 & 124.1 & 169.0 && 347.5 & 388.7 && 9079 KB & 506 KB \\\cmidrule{2-11}\addlinespace[-0.2em]
                                                & \multirow{3}{*}{Non-Uniform} & 1 & 592.9 & 559.2 && 825.8 & 800.6 && 878 MB & 76.6 MB\\\addlinespace[-0.2em]
                                                                              && 2 & 144.6 & 178.5 && 364.3 & 397.8 && 10.9 MB & 835 KB\\\addlinespace[-0.2em]
                                                                              && 3 & 139.6 & 199.8 && 358.5 & 420.0 && 1.4 MB & 85.2 KB\\\midrule
            \multirow{6}{*}{1-Function}       & \multirow{3}{*}{Uniform}       & 1 & 296.2 & 259.3 && 523.9 & 484.5 && 2.68 GB & 153 MB\\\addlinespace[-0.2em]
    ...
    \subsection{Conclusions}{\label{ssec:LSMOC:ET:Conclusions}
      ...
      This investigation indicated that the cause of the instability was the $F_2(\segopt)$ function in the transmission equation.
  ...
  \section{Improved Linear Source Formulation for Multi-physics and 2D/1D Applications}{\label{sec:Improved Linear Source Formulation for Multi-physics and 2D/1D Applications}
    ...
    \subsection{Derivation}{\label{ssec:LSMOC:Derivation}
      ...
      Computing the source requires the flux to be evaluated during the transport sweep.
      ...
      \Cref{eqs:LSMOC:Region-Averaged Flux Moments Definitions} are then simplified into
    ...
    \subsection{Isotropic Simplifications}{\label{ssec:LSMOC:Isotropic Simplifications}
      ...
      \begin{aequation}\label{eq:LSMOC:Isotropic:Region-Averaged Linear Flux Moments}
        \MOCIntegral{\loc\aflux[][g][]} &= \M\frac{\srcL}{\xst}\\ &+ \frac{\fourpi}{V_i\xst}\suml[m]\wt\suml[k]\tA\left[\locIn\dflux+\dirm\segl\left(\frac{\dflux}{\segopt}-\afluxout\right)\right].
      \end{aequation}
    }
  }
  ...
  \section{Results}{\label{sec:LSMOC:Results}
    ...
    \subsection{VERA Problem 2A and 2P Depletion}{\label{ssec:LSMOC:VERA Problem 2A and 2P Depletion}
      ...
      \subsubsection{Problem 2A}{\label{sssec:LSMOC:Problem 2A}
        ...
        \paragraph{2A - Fuel Radius and Azimuthal Divisions}{
          ...
          \Cref{fig:LSMOC:2A:Fuel Azimuthals:Eigenvalues} shows that there is a noticeable affect moving to a single azimuthal division;
    ...
    \subsection{Core Depletion with Feedback}{\label{ssec:LSMOC:Core Depletion with Feedback}
      ...
      The default mesh contains a total of 51,513,673 source-regions, while the coarse mesh contains a total of 14,932,511 source-regions. %19743263
      ...
      \begin{table}[htbp]
        ...
        \end{tabular}
        \footnotetext[1]{Coarse fuel rods but default reflector mesh.}
      \end{table}
