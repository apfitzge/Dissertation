...
\abstract{
  ...
  Since then there has been progress in making 3-D MOC a less computationally burdensome by adopting more advanced discretization methods that overall, lead to fewer spatial mesh regions and rays; namely the linear source approximation, and chord-classification or on-the-fly ray-tracing.
